...
const AddQuestion = (props) => {
  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <div>Your Questions (mandatory) <textarea value={question} placeholder='Why did you like the product or not?' onChange={(e) => setQuestion(e.target.value)} maxLength={1000} /> </div>
