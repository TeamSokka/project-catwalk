...
Each characteristic should appear on its own line.  These characteristics can either be facts regarding the product or values for which the product has a specific quantity.  If the characteristic has a specific value it should display.  If the characteristic is a fact such that it is ‘true’ for the given product, then the value should display as a checkmark.    For any characteristics that do not apply to the product, the value should simply be left blank.
